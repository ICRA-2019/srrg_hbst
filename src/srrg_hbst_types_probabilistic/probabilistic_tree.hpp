...
namespace srrg_hbst {
  ...
  public: EIGEN_MAKE_ALIGNED_OPERATOR_NEW
    ...
    typedef ProbabilisticNodeType_ Node;
  ...
  private:
    ...
    void _setNodesRecursive(const ProbabilisticNodeType_* node_, std::vector<const ProbabilisticNodeType_*>& nodes_collection_) const {
      ...
      if(node_->has_leafs) {
        ...
        _setNodesRecursive(static_cast<const ProbabilisticNodeType_*>(node_->left), nodes_collection_);
        _setNodesRecursive(static_cast<const ProbabilisticNodeType_*>(node_->right), nodes_collection_);
      }
    }
  };
}
